...
public class MainActivity extends BaseActivity {
  ...
  // TODO: Another Board for computer

  EditText username, password;
  String base64EncodedCredentials = "";
  Button loginBtn, showUsersBtn, showComputerBtn;
  ...
  public void onCreate( Bundle savedInstanceState ) {
    ...
    showComputerBtn = (Button)findViewById( R.id.btnChallenge );
  ...
  public void loginToServer( View view ) {
    ...
    if( loginBtn.getText().toString().equals( "Logout" ) ) {
      ...
      //TODO: Change to challenge Computer
      showComputerBtn.setVisibility(View.INVISIBLE);
      showComputerBtn.setVisibility(View.INVISIBLE);
      ...
      client.get( loginUrl, new JsonHttpResponseHandler() {
        ...
        @Override
        public void onSuccess(int statusCode, Header[] headers, org.json.JSONObject user ) {
          try {
          ...
          showComputerBtn.setVisibility( View.VISIBLE );
        ...
        public void onFailure(int statusCode, org.apache.http.Header[] headers, java.lang.Throwable throwable, org.json.JSONObject errorResponse) {
          // Response failed :(
          try {
            Log.i("LOGIN", errorResponse + " i:" + statusCode );
          } catch( Exception e ) {
            e.printStackTrace();
          }
        }
  ...
  public void getComputerOnClick( View v ) {
